...
<form method="post" action="{{ route('update-product-without-photo', [$product->id]) }}" enctype="multipart/form-data">
    @csrf  
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">update new Product</h6>
                ...
                <div class="col-lg-4">
                  <div class="form-group mg-b-10-force">
                    ...
                    <select class="form-control select2" data-placeholder="Choose Category" name="category_id">
                      ...
                      <option value="{{$category->id}}" {{ $category->id == $product->category->id ? 'selected': null }}>{{$category->category_name}} </option>
                ...
                <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group mg-b-10-force">
                      ...
                      <select class="form-control select2" data-placeholder="Choose Brand" name="brand_id">
                        ...
                        <option value="{{$brand->id}}" {{$brand->id == $product->brand->id ? 'selected':null}}>{{$brand->brand_name}}</option> 
                        @endforeach                       
                      </select>
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" data-role="tagsinput" name="product_size" id="size" value="{{$product->product_size}}" placeholder="Enter product size">
                    </div>
                    <div class="form-group">
                        <label class="form-control-label">product color <span class="tx-danger">*</span></label>
                        <input class="form-control" type="text" data-role="tagsinput" name="product_color" id="color" value="{{$product->product_color}}" placeholder="Enter product color">
                      </div>
                  </div><!-- col-4 -->
                  <div class="form-group">
                    <label class="form-control-label">Selling Price <span class="tx-danger">*</span></label>
                    <input class="form-control" type="text"  name="selling_price"  value="{{$product->selling_price}}" placeholder="Enter product price">
                  </div>
  ...
  <div class="row">
    <div class="col-lg-8">
        <label class="ckbox">
            <input type="checkbox" name="main_slider" value=""{{$product->main_slider == 1 ? 'checked':null}}>
            <span>Main Slider</span>
          </label>
        </div>
        <div class="col-lg-8">
        <label class="ckbox">
            <input type="checkbox" name="hot_deal" value="{{$product->hot_deal}}" {{$product->hot_deal == 1 ? 'checked':null}}>
            <span>Hot Deal</span>
          </label>
        </div>
        ...
        <div class="col-lg-8">
          <label class="ckbox">
            <input type="checkbox" name="best_rated" value="{{$product->best_rated}}" {{$product->best_rated == 1 ? 'checked':null}}>
            ...
            <div class="col-lg-8">
                <label class="ckbox">
                  <input type="checkbox" name="mid_slider" value="{{$product->mid_slider}}" {{$product->mid_slider == 1 ? 'checked':null}}>
              ...
              <div class="col-lg-8">
                <label class="ckbox">
                  <input type="checkbox" name="trend" value="{{$product->trend}}" {{$product->trend == 1 ? 'checked':null}}>
                  <span>Trend</span>
                </label>
              </div>
              <div class="col-lg-8">
                <label class="ckbox">
                  <input type="checkbox" name="hot_new" value="{{$product->hot_new}}" {{$product->hot_new == 1 ? 'checked':null}}>
                  <span>Hot New</span>
                </label>
              </div>
...
<br>
            ...
            <img src="{{asset('uploads/product/'.$product->image_one ) }}" style="width:80px; height:80px;">
            <img src="{{asset('uploads/product/'.$product->image_two ) }}" style="width:80px; height:80px;">
            <img src="{{asset('uploads/product/'.$product->image_three ) }}" style="width:80px; height:80px;">
            </div>
        </div>
