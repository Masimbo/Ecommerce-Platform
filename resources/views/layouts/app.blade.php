        ...
        <div class="top_bar">
            ...
            <a href="" data-toggle="modal" data-target="#exampleModal">My Order Traking</a>                   
                ...
                @endphp
                         ...
                         @guest
                         <div><a href="{{ route('login') }}"><div class="user_icon"><img src="{{ asset('public/frontend/images/user.svg')}}" alt=""></div> Login</a></div>
                         <div><a href="{{ route('register') }}"><div class="user_icon"><img src="{{ asset('public/frontend/images/user.svg')}}" alt=""></div> Register</a></div>
